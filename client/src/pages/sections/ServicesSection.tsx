  ...
  return (
    <section id="section-services" ref={ref} className="relative w-full min-h-[950px] bg-dark-mode900">
      ...
      <Button 
        ...
        className="px-5 py-3.5 absolute top-[800px] left-[calc(50.00%_-_149px)] border border-solid border-[#6ae499] inline-flex items-center justify-center gap-2 rounded h-auto bg-transparent"
        onClick={() => {
