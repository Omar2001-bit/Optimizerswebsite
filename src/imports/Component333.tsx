...
export default function Component() {
  return (
    <div className="bg-[#020601] relative w-full min-h-[1000px] shrink-0 overflow-hidden" data-name="Component 333">
      <div className="relative lg:absolute lg:left-1/2 lg:-translate-x-1/2 lg:top-0 lg:w-[1440px] lg:h-full z-10 w-full">
        <Frame7 />
        <Frame9 />
        <Frame8 />
        <Safer />
