...
const Section3 = memo(({ isActive, renderMode = 'full', counterY, mouseX, mouseY, parallaxGain }: {
    isActive: boolean;
                    ...
                    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2425.07 1598.54">
                        ...
                        <defs>
                            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="1247.83" id="filter0_iif_sec3" width="2419.08" x="0" y="316.1">
                                ...
                                <feGaussianBlur result="effect3_foregroundBlur_sec3" stdDeviation="40" />
                            </filter>
                            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="1598.54" id="filter1_f_sec3" width="1582.37" x="842.698" y="0">
                                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                                <feGaussianBlur result="effect1_foregroundBlur_sec3" stdDeviation="40" />
                            </filter>
